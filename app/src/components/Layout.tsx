...
export default function Layout() {
  return (
    <div className="min-h-screen flex flex-col bg-brand-ice text-brand-950 dark:bg-brand-950 dark:text-brand-ice">
      <header className="border-b border-brand-300/30 dark:border-brand-800 px-4 py-4 flex items-center justify-center">
        <img src={logo} alt="CardSharx" className="h-40 w-auto" />
      </header>
